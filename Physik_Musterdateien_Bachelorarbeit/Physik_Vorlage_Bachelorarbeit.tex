...
\begin{figure}[h]
	\begin{center}
		...
		\caption{Anordnung des Detektorsystems: Im Inneren des sph\"arischen Kalorimeters (Crystal-Ball) befanden sich der Detektor zur Teilchenidentifikation (PID) und zwei zur Bestimmung der Teilchen-Trajektorie (MWPC). Die TAPS-Wand befand sich am Ausgang des Crystal-Balls und sorgte daf\"ur, dass der Crystal-Ball einen Raumwinkel von fast 4$\pi$ abdeckte}
	\end{center}
\end{figure}

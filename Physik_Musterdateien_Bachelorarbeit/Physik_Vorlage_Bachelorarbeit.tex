...
Der Mainzer Mikrotron (MAMI) war zur Zeit meiner Bachelorarbeit ein mehrstufiger Rennbahn-Teilchenbeschleuniger für Elektronenstrahlen und stand verschiedenen Arbeirsgruppen
...
1979 wurde das MAMI erstmals in Betrieb genommen und stand seitdem für Experimente zur Verfügung.
Damals bestand das MAMI nur aus einem einzelnen Rennbahn-Mikrotron (RTM), womit eine maximale Elektronenenergie von 14 MeV erreicht werden konnte. 
Im Laufe der Jahre wurde das MAMI um zwei weitere RTMs erweitert, wodurch eine Elektronenenergie von 1,5 GeV erreicht werden konnte.\cite{KPh11} \newline

\subsection{Funktionsprinzip des MAMI}
Um unpolarisierte Elektronen zu erzeugen, wurde eine Glühkathode auf 1000°C erhitzt. Dadurch konnten Elektronen den Heizdraht, aufgrund ihrer thermischen Bewegung, verlassen. Diese Elektronen wurden druch ein elektrisches Feld, welches durch die heiße Kathode und einer Anode, erzeugt wurde, zur Anode beschleunigt und traten dann durch ein Loch in der Anode aus und wurden weiter durch einen Linearbeschleuniger mit einer Frequenz von 2,45 GHz auf ca. 3,5 MeV beschleunigt. \cite{Un08} Diese Frequenz ist für das MAMI typisch und machte es zu einem Dauerstrich-Elektronen-Beschleuniger. Das heißt die Frequenz der Elektron-Pakete war größer, als die Frequenz, mit der die Detektoren einzelene Events auflösen konnten und somit wirkte der Strahl für die Detektoren kontinuierlich.
\newline
...
\bibitem[Un08]{Un08} Dissertation von Marc Unverzagt,  2008 {\em Bestimmung des Damitz-Plot-Parameters \alpha für den Zerfall \eta \arrow 3\pi^{0} mit dem Crystal Ball am MAMI}
\bibitem[KPh11]{KPh11} Internetseite der Kernphysik {\em Mainzer Mikrotron-Geschichte} Internetseite \url{http://www.kernphysik.uni-mainz.de/379.php} (Stand 04.03.2017)

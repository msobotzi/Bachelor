...
\end{table}
 ...
 Folglich lie{\ss} sich der Impuls durch Kenntnis des Auftrefforts des Elektron auf der Tagger-Leiter und der St\"arke des Magnetfeldes bestimmen und dadurch auch seine Energie. Die Energie der Photonen konnte dann mit der Gleichung \ref{eq.Photonenenergie} errechnet werden.
\newline 
\begin{figure}[h!]
	\begin{center}
...
In diesem Fall wurden die Daten aus dem sogenanntem Cocktail genommen. Im Cocktail waren alle physikalisch m\"oglichen Prozesse enthalten, daher hatte er auch seinen Namen. 
...
Dazu wurde ein Histogramm mit den Bedingungen aus Kapitel \ref{sec:Varnachlaessigung-der-Detektoren-am-Rand} gef\"ullt, da mit diesen Bedingungen kleinste Abweichung erzielt wurde. \"Uber dieses Histogramm wurde dann wieder gefittet, um die $\pi^0$ Position zu bestimmen.
...
Hier wurde ein weiterer Vorteil der Simulation ausgenutzt.
%Diesesmal wurden allerdings keine reellen Daten aus Strahlzeiten genommen, sondern es wurde auf Simulationen zur\"uckgegriffen. Der Grund daf\"ur war, dass 
Aus den im Experiment genommenen Daten konnte n\"amlich nicht der Ort bestimmt werden, an dem das $\pi^0$ zerfallen ist. Daf\"ur gab es keine Detektoren im Crystal-Ball. In Simulationen waren alle Prozesse allerdings wohl bekannt. So wusste man auch von jeden Prozess an welchem Ort er sich ereignete. 
...
\subsection{Zerfall eines ruhenden $\pi^0$ im Ursprung}

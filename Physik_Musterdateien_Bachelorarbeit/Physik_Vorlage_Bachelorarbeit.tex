...
Im Laufe der Jahre wurde das MAMI um zwei weitere RTMs erweitert, wodurch eine Elektronenenergie von 1,5 GeV erreicht werden konnte. \newline

\subsection{Funktionsprinzip des MAMI}
Um unpolarisierte Elektronen zu erzeugen, wurde eine Glühkathode auf 1000°C erhitzt. Dadurch konnten Elektronen den Heizdraht, aufgrund ihrer thermischen Bewegung, verlassen. Diese Elektronen wurden druch ein elektrisches Feld, welches durch die heiße Kathode und einer Anode erzeugt wurde, zur Anode beschleunigt und traten durch ein Loch in der Anode aus und wurden weiter durch einen Linearbeschleuniger auf 3,5 MeV beschleunigt.

...
\begin{figure}[!tp]
	\centering
		\begin{minipage}[b]{0.4\textwidth}
			\includegraphics[width=50mm]{20172803SymmetricUnchargedGaussianFitExample}
		
		\end{minipage}
		\hfill
		\begin{minipage}[b]{0.4\textwidth}
			\includegraphics[width=50mm]{20172803SymmetricUnchargedGaussianFitExampleZommed}
		\end{minipage}
	\caption{Beispiel eines Gau{\ss}fits. Rechts ist der gleiche Fit zu sehen nur herangezoomet. Man kann eine leichte Tendenz des Fits nach rechts erkennen}
\end{figure}

...
Da es sich hierbei um  Simulationen handelte, wusste man, welche Photonen durch welchen Prozess erzeugt wurden. Folglich konnte alles so eingestellt werden, dass aus dem Cocktail nur $\pi^0 \rightarrow \gamma \gamma$ Prozesse betrachtet wurden.
...
Das 3-D Z-Vertex Histogramm wurde dann mit den Daten aus der Cocktail Simulation gefüllt. Auch hier wurden nur $\pi^0 \rightarrow \gamma \gamma$ Prozesse betrachtet.

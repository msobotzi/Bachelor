...
Da in vielen Schritten eine Raumrichtung oder ein Energieinterval gew\"urfelt werden musste und die neue Gun einer alten basierte, wurde erst das bereits benutzte TRandom aus ROOT zur\"uckgegriffen. Dieses besa{\ss} eine Periodizit\"at von $10^9$ und ben\"otigte zum Generieren einer Zahl 34 ns. Allerdings stellte sich heraus, dass dieser Zufallsgenerator nicht gut f\"ur viele gr\"o{\ss}ere Pakete ist, da durch ihn keine gleichm\"a{\ss}ige Verteilung, sondern '\textit{Nadeln}' entstanden, was darauf hindeutete, dass der Generator immmer wieder die gleichen Prozesse w\"urfelte (vgl. dazu Abb. \ref{fig:Schlechte-Verteilung-der-Daten}). Folglich musste es ausgetauscht und durch das ebenfalls von ROOT bereitgestellten TRandom3 ersetzt werden. Dessen Periodizit\"at lag bei $10^{6000}$. Zwar ben\"otigte er mit 45 ns pro gew\"urfelter Zahl etwas mehr Zeit, daf\"ur entsprach die Verteilung mehr der erwarteten.
...
\subsection{Zerfall von $\pi^0$ im Ursprung mit Boost in z-Richtung}

\subsection{Isotroper Zerfall von $\pi^0$ in einem langen Target}
...
\begin{figure}[h!]
	\begin{center}
		\includegraphics[width=100mm]{20171104BadRandomGenerator}
	\end{center}
	\caption{Beispiel einer durch die Gun-Generierten Verteilung. Zu erkennen sind sehr viele Nadeln, was auf eine schlechte Verteilung hindeuted. Es handelt sich dabei um das Histogramm f\"ur symmetrische Photonen mit einer Energie von 375 MeV bis 400 MeV und einem Z-Vertex von -5 cm bis -4 cm. F\"ur weitere Details siehe \ref{sec:Z-Vertex-Abaengigkeit}}
	\label{fig:Schlechte-Verteilung-der-Daten}
\end{figure}

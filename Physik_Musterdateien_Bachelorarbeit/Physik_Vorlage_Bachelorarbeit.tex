...
\section{Motivaton}
{
	...
	Die A2-Kollaboration untersuchte die innere Struktur von Nukleonen mit Hilfe eines, durch Bremsstrahlung erzeugten, reellen Photonenstrahls. 
	...
	Der Crystal-Ball Detektor bestand aus 672 Natriumiodid Kristallen und deckte ca. 94\% des Raumwinkels ab. 
	\newline
	\newline
	 Die Masse des $\pi^0$-Meson liegt bei 135 MeV und kann als bekannt vorausgesetzt werden. Das bedeutet, dass Detektoren, welche Mesonen in diesem Enernergiebereich nachweisen, auf diesen Peak kalibriert werden.
	 Folglich kann mit diesem Wissen überprüft werden, ob die Kalibrierung der Detektoren stimmt.

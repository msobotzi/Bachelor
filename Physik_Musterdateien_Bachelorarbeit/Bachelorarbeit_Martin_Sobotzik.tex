...
Auch hier hatte die Abweichung zwischen der errechneten invarianten Masse und der $\pi^0$ Masse die gleiche Form. So lag nur eine geringe Abweichung f\"ur alle Z-Vertices bei niedrigen Photonenenergien vor. Diese betrug maximal etwa -0,5\%. Nahm die Photonenenergie allerdings zu

\colorbox{yellow}{Form total komisch; Kreuzung und hintere Ausreisser}
...
\end{figure}
 ...
 In den Plots von Abbildung \ref{fig:Erec-Egen} wurde die tats\"achliche Energie der Teilchen von der detektierten abgezogen. Sprich liegt eine positive Abweichung vor, dann wurde zu viel Energie im Detektor registriert nud vise versa.

...
Deswegen wird zur Bestimmung der $\pi^0$-Position f\"ur die simulierten Daten der Untergrundfit ausgeschaltet, sodass die Crystal-Ball-Funktion die einzige Fitfunktion ist. Auch der Bereich über den gefittet wird, wird hier mit 50 MeV bis 220 MeV konstant gehalten. 
...
In Abbildung \ref{fig:True-OpeningAngle} links ist zu sehen, wie der \"Offnungswinkel $\alpha$ f\"ur gr\"o{\ss}er werdende Energien kleiner wird. Aus der Abbildung kann man auch entnehmen, dass f\"ur einen \"Offnungswinkel von 30$^{\circ}$ die maximale Photonenenergie 250 MeV betr\"agt.
...
Es kann nur sein, dass der $\pi^0$-Peak ab einer Photonenenergie von 225 MeV zu stark durch den Untergrung gest\"ort wird, da dieser durch diesen Schnitt nicht reduziert wird, die St\"arke des $\pi^0$-Peaks allerdings schon.

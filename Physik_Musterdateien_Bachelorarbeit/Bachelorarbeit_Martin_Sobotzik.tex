...
Schlie{\ss}lich muss noch überprüft werden, ob der neue Ereignisgenerator so wie der alte funktioniert. Dazu wird auch der alte Ereignisgenerator so eingestellt, dass die Energieverteilung des eintreffenden Photonenstrahls homogen im Intervall von $1580\,\text{MeV}$ bis $1604\,\text{MeV}$ verteilt ist. Dadurch ist ein einfacherer Vergleich m\"oglich. 
